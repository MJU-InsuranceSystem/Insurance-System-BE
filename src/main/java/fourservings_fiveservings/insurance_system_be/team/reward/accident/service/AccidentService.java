...
import fourservings_fiveservings.insurance_system_be.team.reward.accident.controller.dto.request.RegisterAccidentRequestDto;
import fourservings_fiveservings.insurance_system_be.team.reward.accident.controller.dto.request.ReviewAccidentRequestDto;
import fourservings_fiveservings.insurance_system_be.team.reward.accident.controller.dto.response.AccidentListResponseDto;
import fourservings_fiveservings.insurance_system_be.team.reward.accident.controller.dto.response.AccidentResponseDto;
...
import fourservings_fiveservings.insurance_system_be.team.reward.accident.repository.AccidentRepository;
...
//        String fileUrl = s3Service.getFileUrl(FIleType.ACCIDENT.getLabel(), accident.getFileName());
        return AccidentResponseDto.from(accident, accident.getFileName());
    }
