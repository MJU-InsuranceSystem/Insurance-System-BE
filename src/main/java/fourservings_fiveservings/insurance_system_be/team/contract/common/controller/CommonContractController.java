...
public class CommonContractController implements ContractApi {
    ...
    public ApiResponse<?> getContractListBySubscriberId(Long subscriberId) {
        List<ContractListResponseDto> contractList = contractService.getContractListBySubscriberId(
            subscriberId);
        return ApiResponse.success(SuccessType.SUCCESS, contractList);
    }
}
