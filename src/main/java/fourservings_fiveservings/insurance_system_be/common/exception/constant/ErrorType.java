...
public enum ErrorType {
    ...
    NO_EXIST_CAR_TYPE(HttpStatus.NOT_FOUND, "CONTRACT-004", "타입 변환할 자동차 타입이 없습니다"),
    NO_EXIST_LICENSE_TYPE(HttpStatus.NOT_FOUND, "CONTRACT-005", "타입 변환할 면허 타입이 없습니다."),
    NO_EXIST_OWNER_TYPE(HttpStatus.NOT_FOUND, "CONTRACT-006", "타입 변환할 소유 타입이 없습니다."),
    NOT_APPROVE(HttpStatus.FORBIDDEN, "CONTRACT-007", "계약 허가가 나지 않았습니다."),
